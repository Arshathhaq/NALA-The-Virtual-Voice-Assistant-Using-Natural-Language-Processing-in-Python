...
def record_audio_and_save(save_path, n_times=2):
    """
...
record_audio_and_save("C:/Users/arsha/Desktop/AudioData", n_times=2) 

# Step 2: Record your background sounds (Just let it run, it will automatically record)
print("Recording the Background sounds:\n")
record_background_sound("C:/Users/arsha/Desktop/background_sound", n_times=5)
